outcome2_tab <- function() {
  nav_panel(
    ...
    gov_main_layout(
      ...
      gov_row(
        p(
          htmlOutput("outcome_two_choice_text1"),
          htmlOutput("outcome_two_choice_text2")
        ),
        # conditionalPanel(
        ...
        div(
          tabsetPanel(
            ...
            tabPanel(
              ...
              fluidRow(
                ...
                column(
                  ...
                  value_box(
                    title = HTML(
                      "Hospital admissions caused by unintentional and deliberate injuries to children and young people <br> (0 to 14 years)"
                    ),
              ...
              accordion(
                accordion_panel(
                  ...
                  gov_row(
                    h2(
                      "Proportion of ICPCs to S47 enquiries by local authority"
                    ),
                    br(),
                ...
                accordion_panel(
                  ...
                  gov_row(
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "table_cpp_repeat_reg",
                          filename = "Repeat_CPP_rates_regions.csv"
                        ),
                  ...
                  gov_row(
                    h2(
                      "Repeat child protection plan (CPP)  by local authority"
                    ),
                    p(sprintf(
                ...
                accordion_panel(
                  ...
                  insert_text(
                    inputId = "CIN_CPP__longdefinition",
                    text = paste(
                      "A child becomes the subject of a child protection plan if they are assessed as being at risk of harm, at an initial child protection conference. Child protection is focused on investigating and addressing
                    significant harm that children might experience. Remaining
                    on a CPP for a longer period of time or having multiple
                  ...
                  details(
                    ...
                    help_text = (HTML(paste0(
                      csvDownloadButton(
                        "table_duration_cpp",
                        filename = "CPP_more_than_2years_rates.csv"
                      ),
                  ...
                  gov_row(
                    h2(
                      "Child protection plans (CPP) longer than 2 years, by region"
                    ),
                    p(
                      "This is a static chart and will not react to geographical level and location selected in the filters at the top."
                    ),
                  ...
                  gov_row(
                    h2(
                      "Child protection plans (CPP) longer than 2 years, by local authority"
                    ),
                    p(sprintf(
                      "The charts below represent data from %s.",
                ...
                accordion_panel(
                  ...
                  gov_row(
                    h2(
                      "Hospital admissions caused by unintentional and deliberate injuries to children and young people (0 to 14 years)"
                    ),
                    # p("Hospital admissions"),
                    insert_text(
                      inputId = "hospital_admissions_definition",
                      text = paste(
                        "<b>",
                        "Hospital admissions",
                        "</b><br>",
                  ...
                  gov_row(
                    h2(
                      "Hospital admissions caused by unintentional and deliberate injuries to children and young people (0 to 14 years), by region"
                    ),
                    p(
                      "This is a static chart and will not react to geographical level and location selected in the filters at the top."
                    ),
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "admissions_region_tbl",
                          filename = "hospital_admissions_rates_region.csv"
                        ),
                  ...
                  gov_row(
                    h2(
                      "Hospital admissions caused by unintentional and deliberate injuries to children and young people (0 to 14 years) by local authority"
                    ),
                    br(),
                    radioGroupButtons(
            ...
            tabPanel(
              ...
              gov_row(
                h2(
                  "Factors identified at the end of assessment in the year to 31 March, related to child abuse or neglect"
                ),
                p(
                  "This metric looks at those children who are assessed as needing support for child abuse or neglect."
                ),
                warning_text(
                  inputId = "assessment_factors_def1",
                  text = paste(
                ...
                details(
                  ...
                  help_text = (HTML(paste0(
                    csvDownloadButton(
                      "child_abuse_all_af_tbl",
                      filename = "child_abuse_all_factors.csv"
                    ),
                ...
                details(
                  ...
                  help_text = (tags$ul(
                    ...
                    tags$li(
                      "Figures exclude the category 'no factors identified'."
                    ),
                    tags$br(),
                    p(
              ...
              gov_row(
                div(
                  ...
                  style = "min-height:100%; height = 100%; overflow-y: visible",
                  p(
                    "This domain contains breakdowns of data for the following assessment factors: ",
                    paste0(
                      paste(
                        unique(af_child_abuse_extra_filter %>% str_sort()),
                        collapse = ", "
                      ),
                      "."
                    )
                  ...
                  p(
                    "Use the dropdown below to select which assessment factor you would like to see in the below accordions:"
                  ),
                  selectizeInput(
                    inputId = "assessment_factors_1",
                    label = "Select an assessment factor:",
                    choices = unique(
                      af_child_abuse_extra_filter %>% str_sort()
                    ),
                    selected = NULL,
                    multiple = FALSE,
                    options = NULL
                    ...
                    accordion_panel(
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "ca_ts_tbl",
                              filename = "child_abuse_rates.csv"
                            ),
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "child_abuse_region_tbl",
                              filename = "child_abuse_rates_regions.csv"
                            ),
            ...
            tabPanel(
              ...
              gov_row(
                h2(
                  "Factors identified at the end of assessment in the year to 31 March, related to specific types of harms outside the home"
                ),
                p(
                  "This metric looks at those children who are assessed as needing support for harms outside the home."
                ),
                warning_text(
                  inputId = "assessment_factors_def2",
                  text = paste(
                    "Factors identified at the end of assessment are additional factors that social workers record as being relevant in an episode of need.
                  The majority of children have more than one factor recorded for each episode of need.
                  It should be noted that not all episodes have factors recorded, but this has improved over time.
                ...
                details(
                  ...
                  help_text = (HTML(paste0(
                    csvDownloadButton(
                      "extra_familial_all_af_tbl",
                      filename = "EFH_all_factors.csv"
                    ),
              ...
              gov_row(
                div(
                  ...
                  p(
                    ...
                    paste0(
                      paste(
                        unique(extra_familial_harm_af %>% str_sort()),
                        collapse = ", "
                      ),
                      "."
                    )
                        ...
                        details(
                          ...
                          help_text = (
                            ...
                            tagList(
                              csvDownloadButton(
                                "efh_region_tbl",
                                filename = "EFH_rates_regions.csv"
                              ),
