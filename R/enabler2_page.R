enabler2_tab <- function() {
  nav_panel(
    ...
    gov_main_layout(
      ...
      gov_row(
        p(
          htmlOutput("enabler2_choice_text1"),
          htmlOutput("enabler2_choice_text2")
        ),
      ),
      gov_row(
        div(
          tabsetPanel(
              ...
              accordion(
                accordion_panel(
                  ...
                  gov_row(
                    ...
                    p(
                      "This metric provides contextual information on the resource prioritisation within each local authority."
                    ),
                    ...
                    div(
                      ...
                      style = "min-height:100%; height = 100%; overflow-y: visible",
                      p(
                        "This domain contains two levels of data: Share of total LA spend on children's services and average per capita (of all children in a local authority) spend on children's services"
                      ),
                      p(
                        "Use the dropdown below to select which level of spending data you would like to see in the charts below:"
                      ),
                      selectizeInput(
                        ...
                        choices = c(
                          ...
                          "Spend per child on children's services"
                        ),
                        selected = NULL,
                        multiple = FALSE,
                        options = NULL,
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "table_tot_spending_reg",
                              filename = "spend_on_CSC_regions.csv"
                            ),
                        ...
                        details(
                          ...
                          help_text = (tags$ul(
                            ...
                            tags$li(
                              "Share of spend at a national level includes lower tier local authorities. Share of spend at a regional level aggregates the spend of the local authorities in the dashboard and therefore does not include lower tier local authorities."
                            ),
                            tags$li(
                ...
                accordion_panel(
                  ...
                  gov_row(
                    ...
                    p(
                      "Prioritising funding and resources that help families early helps children and young people thrive. This metric looks at the resource prioritisation between early and later statutory intervention."
                    ),
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "table_spend_excl_cla_reg",
                          filename = "spend_on_CSC_excl_CLA_regions.csv"
                        ),
            ...
            tabPanel(
              ...
              conditionalPanel(
                ...
                fluidRow(
                  p(
                    "The culture of leadership drives effective and efficient practice. Ofsted rating for leadership provides a summary judgement of the assessed culture and practice of leadership within each authority."
                  ),
                )
              ),
              accordion(
                accordion_panel(
                  ...
                  gov_row(
                    warning_text(
                      inputId = "warn",
                      text = "Latest leadership rating years for each local authority may differ. View the table below to see the latest year for each LA."
                    ),
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "ofsted_latest_ratings_tbl",
                          filename = "Ofsted_leadership_ratings_all_LA_rating_date.csv"
                        ),
                  ...
                  gov_row(
                    ...
                    warning_text(
                      inputId = "warn",
                      text = "Latest leadership rating years for each local authority may differ. View the table at the top to see the latest year for each LA."
                    ),
                    p(
                      "This is a static chart and will not react to geographical level, location, or comparison checkboxes selected in the filters at the top."
                    ),
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "ofsted_tbl",
                          filename = "Ofsted_leadership_ratings_national.csv"
                        ),
                    ...
                    details(
                      ...
                      help_text = (tags$ul(
                        tags$li(
                          "For more information on how Ofsted rate local authorities on their leadership, see the ",
                          a(
                            href = "https://www.gov.uk/government/publications/inspecting-local-authority-childrens-services-from-2018/inspecting-local-authority-childrens-services",
                        ...
                        tags$li(
                          "The Ofsted leadership rating is sub-judgement rating and not the overall Ofsted rating."
                        )
                      ))
                    )
                  ),
                  gov_row(
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "ofsted_reg_tbl",
                          filename = "Ofsted_leadership_ratings_regions.csv"
                        ),
