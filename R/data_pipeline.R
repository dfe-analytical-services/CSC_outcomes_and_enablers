...
if (TRUE == FALSE) { # this IF statement is to prevent the following block of code from running if sourced
  ...
  saveRDS(pipeline_run$pipeline_comparison, file = "~/CSC shiny dashboard/Data QA/pipeline_comparison_s47_icpc_v1.rds")
  ...
  writexl::write_xlsx(x = pipeline_run$pipeline_comparison$consolidated_setdiffs_summary, "~/CSC shiny dashboard/Data QA/Consolidated SetDiff S47 ICPC.xlsx")
  ...
  writexl::write_xlsx(deltas_to_export, "~/CSC shiny dashboard/Data QA/school_stability/pipeline_consolidated_setdiffs_s47_icpc_v1.xlsx")
  ...
  reason_for_pipeline_run <- "Correction to s47 data for Stat neighbours due to rounding" # <---- EDIT HERE
