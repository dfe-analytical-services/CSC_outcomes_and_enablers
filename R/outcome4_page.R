  ...
  nav_panel(
    ...
    gov_main_layout(
      gov_row(
        column(
          width = 12,
          h2("Outcome 4: Children in care and care leavers have stable, loving homes"),
        )
      ),
      gov_row(
        div(
                ...
                accordion_panel(
                  ...
                  gov_row(
                    ...
                    div(
                      ...
                      p("Use the dropdown below to select which placement type you would like to see in this accordion:"),
                      selectizeInput(
            ...
            tabPanel(
              ...
              fluidRow(
                div(
                  ...
                  p("Use the dropdown below to select which age range of care leavers you would like to see in the accordions below:"),
                  selectizeInput(
                    inputId = "leavers_age",
