outcome4_tab <- function() {
  nav_panel(
    ...
    gov_main_layout(
          ...
          layout_columns(
            ...
            conditionalPanel(
              ...
              column(
                width = 12,
                checkbox_Input(
                  inputId = "sn_comparison_checkbox_o4",
                  cb_labels = "Compare with statistical neighbours",
                  checkboxIds = "Yes_sn_o4",
                  label = "",
                  hint_label = NULL,
                  small = TRUE
                )
      ...
      gov_row(
        p(
          htmlOutput("outcome4_choice_text1"),
          htmlOutput("outcome4_choice_text2")
        ),
        # conditionalPanel(
          ...
          tabsetPanel(
            ...
            tabPanel(
              ...
              accordion(
                ...
                accordion_panel(
                  ...
                  p(
                    "Those children who cannot remain living with families or family network should be provided with a stable home environment. Minimising changes to the number of times that children have to move home while in care is key to this ambition."
                  ),
                  gov_row(
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "placement_changes_tbl",
                          filename = "cla_more_than_3_placements.csv"
                        ),
                  ...
                  gov_row(
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "placement_changes_region_tbl",
                          filename = "cla_more_than_3_placements_regions.csv"
                        ),
                  ...
                  gov_row(
                    h2(
                      "Percentage of CLA with 3 or more placements during the year by LA"
                    ),
                    p(sprintf(
                ...
                accordion_panel(
                  ...
                  gov_row(
                    ...
                    p(
                      "Children should be supported to remain in school placements and to retain contact with friends and family networks where this is in their best interests. As such, where possible, children should be supported to remain close to their home address."
                    ),
                    insert_text(
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "placement_dist_tbl",
                          filename = "placements_more_than_20_miles_from_home.csv"
                        ),
                  ...
                  gov_row(
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "placement_dist_region_tbl",
                          filename = "placements_more_than_20_miles_from_home_regions.csv"
                        ),
                  ...
                  gov_row(
                    h2(
                      "Placements more than 20 miles from home by local authority"
                    ),
                    p(sprintf(
                      "The charts below represent data from %s.",
                ...
                accordion_panel(
                  ...
                  p(
                    "This indicator looks at the proportion of children living in different placement types. Where possible, the aim is to support children in care to live in foster care arrangements."
                  ),
                  gov_row(
                    ...
                    div(
                      ...
                      style = "min-height:100%; height = 100%; overflow-y: visible",
                      p(
                        "This indicator contains breakdowns of data for the following placement types: ",
                        paste(
                          unique(placement_type_filter %>% str_sort()),
                          collapse = ", "
                        ),
                        "."
                      ),
                      p(
                        "Use the dropdown below to select which placement type you would like to see in this accordion:"
                      ),
                      selectizeInput(
                      ...
                      gov_row(
                        h2(
                          "Percentage of children living in foster, secure homes, children's homes, or supported accommodation by region"
                        ),
                        p(
                          "This chart will only react to the placement type filter, not the geographical level and location selected in the filters at the top."
                        ),
                        br(),
                        insert_text(
                          inputId = "Placement_types",
                          text = paste(
                            ...
                            "</b><br>",
                            htmlOutput(
                              "outcome4_choice_placement_type_by_region_text"
                            )
                          )
                        ),
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "placement_type_region_tbl",
                              filename = paste0("placement_type_regions.csv")
                            ),
                      ...
                      gov_row(
                        h2(
                          "Percentage of children living in foster, secure homes, children's homes, or supported accommodation by LA"
                        ),
                        p(sprintf(
                          "The charts below represent data from %s.",
                          max(placement_data$time_period)
                        ...
                        insert_text(
                          ...
                          text = paste(
                            ...
                            "</b><br>",
                            htmlOutput(
                              "outcome4_choice_placement_type_by_la_text"
                            )
                          )
                        ),
                        radioGroupButtons(
                ...
                accordion_panel(
                  ...
                  gov_row(
                    div(
                      ...
                      p(
                        "For those children for whom adoption has been assessed as the right option, ensuring that the child moves to an appropriate home as soon as possible will increase stability for the child."
                      ),
                      class = "input_box",
                      style = "min-height:100%; height = 100%; overflow-y: visible",
                      insert_text(
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "placement_order_match_tbl",
                              filename = paste0(
                                "avg_time_between_placement_order_and_match.csv"
                              )
                            ),
                        ...
                        details(
                          ...
                          help_text = (tags$ul(
                            tags$li(
                              "Due to data availability, only national level stats are available for this chart."
                            ),
                            tags$li(
                              "Average time rounded to the nearest month."
                            ),
                            tags$li(
            ...
            tabPanel(
              ...
              fluidRow(
                br(),
                p(
                  "Understanding the emotional and behavioural need of CLA is important to ensure that they are receiving the care and support they need to thrive. The SDQ score uses a series of carer-reported measures to calculate an overall score to assess the emotional wellbeing of CLA."
                ),
              ),
              accordion(
                accordion_panel(
                  ...
                  gov_row(
                    ...
                    insert_text(
                      ...
                      text = paste(
                        ...
                        " -  The SDQ is a behavioural screening questionnaire. Its primary purpose is to give social workers and health professionals information about a child’s wellbeing. A score of 0 to 13 is considered normal, 14 to 16 is borderline, and 17 to 40 is a cause for concern."
                      )
                    ),
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "sqd_ts_table",
                          filename = paste0("wellbeing_sdq_score.csv")
                        ),
                  ...
                  gov_row(
                    ...
                    details(
                      ...
                      help_text = (HTML(paste0(
                        csvDownloadButton(
                          "SDQ_region_tbl",
                          filename = paste0("wellbeing_sdq_score_regions.csv")
                        ),
            ...
            tabPanel(
              ...
              fluidRow(
                ...
                br(),
                p(
                  "Care leavers should be supported to access education, employment and
                  training that supports them and allows them to achieve their aspirations and goals."
                ),
                insert_text(
                  inputId = "care_leavers_def",
                  text = paste(
                    tags$b("Data collected on care leavers"),
                    tags$br(),
                    "Local authorities provide information about children who were previously looked after, who turned 17 to 21 in the year.
              ...
              fluidRow(
                div(
                  ...
                  style = "min-height:100%; height = 100%; overflow-y: visible",
                  p(
                    "This domain contains breakdowns of data for the following age ranges: 17 to 18 years and 19 to 21 years."
                  ),
                  p(
                    "Use the dropdown below to select which age range of care leavers you would like to see in the accordions below:"
                  ),
                  selectizeInput(
                    inputId = "leavers_age",
                    label = "Select an age range:",
                    choices = unique(
                      care_leavers_accommodation_data$age %>% str_sort()
                    ),
                    selected = NULL,
                    multiple = FALSE,
                    options = NULL
                    ...
                    accordion_panel(
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "cl_activity_ts_tbl",
                              filename = paste0("care_leavers_activity.csv")
                            ),
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "cl_activity_region_tbl",
                              filename = "care_leavers_activity_region.csv"
                            ),
                    ...
                    accordion_panel(
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "cl_accommodation_ts_tbl",
                              filename = paste0("care_leavers_accomm.csv")
                            ),
                      ...
                      gov_row(
                        ...
                        details(
                          ...
                          help_text = (HTML(paste0(
                            csvDownloadButton(
                              "cl_accommodation_region_tbl",
                              filename = paste0(
                                "care_leavers_accomm_regions.csv"
                              )
                            ),
