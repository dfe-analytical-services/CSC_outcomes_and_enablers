      ...
      gov_row(
        column(
          ...
          p(
            ...
            a(
              href = "https://forms.office.com/e/dMDRycTXcU",
              target = "_blank",
          ...
          p(
            ...
            a(
              href = "mailto:CSCDashboard.FEEDBACK@education.gov.uk",
              target = "_blank",
              "CSCDashboard.FEEDBACK@education.gov.uk",
              .noWS = c("after")
            ),
            "."
          ),
          ...
          p(
            ...
            a(
              href = "https://github.com/dfe-analytical-services/CSC_outcomes_and_enablers",
              target = "_blank",
