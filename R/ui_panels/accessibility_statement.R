    ...
    gov_main_layout(
      gov_row(
        column(
          width = 12,
          h2(
            "Accessibility statement for Children's Social Care - Outcomes and Enablers dashboard"
          ),
          p(
          ...
          tags$div(tags$ul(
            tags$li(
              "Some form elements do not have appropriate labels (checkboxes)."
            ),
            tags$li(
              "Items other than <li>, <script> and <template> have been included under <ul> or <ol> tags (<br> and <p>)."
            ),
            tags$li(
              "<li> items have been placed in contexts other than <ul> or <ol>."
            ),
            tags$li(
              "Charts have non-accessible components that are inaccessible for keyboard users."
            ),
            tags$li(
              "Chart areas display incorrectly when using a small screen or high zoom (300%)."
            ),
            tags$li(
              "Chart labels overlap and become unreadable when using a small screen or high zoom (300%)."
            ),
            tags$li(
              "Chart tooltips created by Plotly contain empty links acting as a significant barrier to keyboard navigation and screen reader use."
            ),
            tags$li(
              "Charts are neither marked as to be ignored or have alternative text and give confusing output produced by the Plotly package used to create them."
            )
          )),
          ...
          p(
            "This statement was prepared on 1st July 2024. It was last reviewed on 8th October 2024."
          ),
          p(
