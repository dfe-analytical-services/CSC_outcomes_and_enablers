...
plot_ethnicity_rate <- function(geo_breakdown, geographic_level) {
  ethnicity_data <- workforce_eth[
    workforce_eth$geo_breakdown %in% geo_breakdown & workforce_eth$OrgRole == "All children and family social workers",
...
plot_population_ethnicity_rate <- function(geo_breakdown, geographic_level.x) {
  ...
  combined_ethnicity_data_long <- reshape2::melt(combined_ethnicity_data,
    ...
    measure.vars = c(
      "Workforce_WhitePercentage", "Workforce_BlackPercentage", "Workforce_AsianPercentage",
...
plot_seniority_eth <- function(geo_breakdown, geographic_level) {
  ethnicity_data_sen <- workforce_eth_seniority[
    workforce_eth_seniority$geo_breakdown %in% geo_breakdown & workforce_eth_seniority$seniority != "All children and family social workers",
