...
params:
  ...
  pipeline_comparison_file: "~/CSC shiny dashboard/Data QA/sw_stability/pipeline_comparison_adjust_metadata_step_1_v1.rds"
...
if (!(is.null(params$pipeline_comparison))) {
  ...
  browser()
  pc <- readRDS(file = params$pipeline_comparison_file)
  browser()
}
# 
# csd <- pc$consolidated_setdiffs$cla_rates
# 
# csd[, .N, by = .(old,new)]
# 
